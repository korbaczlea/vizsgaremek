...
export const defaultHomeContent = {
  ...
  subhead:
    "Unique mandalas, coasters, decorations and wall clocks — crafted with care. Custom requests are welcome.",
  trust: [
  ...
  why_body:
    "Mandalas are loved worldwide as mindful decorations. They can support a calm atmosphere, help with relaxation, and bring harmony into your space. Many people use mandalas as a visual focus during meditation.",
  why_bullets: [
  ...
  process_body:
    "Each piece is painted step-by-step with patience and precision. I use quality paints and carefully selected surfaces to make the artwork durable and detailed.",
  steps: [
